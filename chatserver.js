// chatserver.js (Deno版と100%同じ仕組みで動くNode.js/Expressコード)
...
// 通常の画面アクセス時は、URL入力バー＆iframe＆右下チャット付きの豪華な本家画面を返す！
app.get('/', (req, res) => {
  res.send(`
    <!DOCTYPE html>
    <html lang="ja">
...
// 💡 【超安定】Supabaseなどの外部連携をすべて綺麗にカット！
// あなたがスマホとPCで「完璧にできた！」と喜んでくれた、大元のDeno版と100%全く同じメモリ保持ロジックです。
const wss = new WebSocketServer({ server });
const chatHistory = [];

wss.on('connection', (ws) => {
  // 繋がった瞬間に、メモリ内の過去ログをそのまま届ける
