// chatserver.js
// Render 用
// WebSocketチャット + Google Spreadsheet永久保存
// タイムスタンプはRender側で1回だけ生成
...
// GASの「ウェブアプリ」デプロイURL
// ※ 必ずGASのデプロイ画面から /exec URLを直接コピーしてください
...
// GAS履歴を複数接続から同時ロードしないためのPromise
